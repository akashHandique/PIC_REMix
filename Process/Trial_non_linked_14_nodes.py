...
converter_capacityParam.loc[idx[["R1_data","R2_data"], :, "BG_N"], "unitsUpperLimit"] = 1  # GW_el # 0.167
converter_capacityParam.loc[idx[["R1_data","R2_data"], :, "BG_N"], "unitsLowerLimit"] = 0
...
sourcesink_annualSum.loc[idx[["R1_data","R2_data"], :, :, :], "upper"] = 211
sourcesink_annualSum.loc[idx[["R1_data","R2_data"], :, :, :], "lower"] = 0
