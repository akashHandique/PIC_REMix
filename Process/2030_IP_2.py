...
# %%
# load input data
profiles = pd.read_csv("../_input/IP_2030_14_PIC.csv", index_col=0)
# %% [markdown]
...
capacity_limits = {
    ...
    "FJ_data": {
        ...
        "BG_N": (0, 1000),
        "PV_N": (0, 1000),
        "WindOnshore_N": (0, 201000),
        "Wave_N": (0, 1000),
        "WindOffshore_N": (0, 1000)# hydro adjusted
    },
    "FSM_data": { 
        "DG": (0, 0.0388),
        "PV_B": (0.0028, 0.0028),
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [
            ["BG_N", "PV_N", "WindOnshore_N", "Wave_N","WindOffshore_N"],
            ['2030'],
            ["Powergen"],
            ["Biomass", "Elec", "CO2"],
        ]
...
for data_node in ["CI_data","FJ_data","FSM_data", "KB_data","MI_data","NU_data","NE_data","PU_data","PNG_data","SA_data","SI_data","TA_data","TU_data","VU_data"]:
    ...
    techs = ["PV_B", "WindOnshore_B", "Hydro_B", "Geothermal_B", "BG_B","PV_N", "WindOnshore_N", "Wave_N", "WindOffshore_N", "BG_N"]
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [
            ...
            ["global"],
            ["horizon"],
            ["DG", "PV_N", "WindOnshore_N", "Wave_N", "WindOffshore_N", "BG_N"],
            ['2030'],
        ]
    )
).sort_index()
...
converter_capacityParam.loc[idx[["CI_data","FJ_data","FSM_data","KB_data","MI_data","NU_data","NE_data","PU_data","PNG_data","SA_data","SI_data","TA_data","TU_data","VU_data"], :, "Battery"], "unitsUpperLimit"] = (
  30  # GW_el Converter upper limit
)
...
] = 4.5  # million EUR per unit and year
accounting_converterUnits = accounting_converterUnits.fillna(0)
