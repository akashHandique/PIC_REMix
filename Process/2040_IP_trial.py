# -*- coding: utf-8 -*-
"""
Created on Thu Sep 25 17:35:40 2025
...
# %%
# load input data
profiles = pd.read_csv("../_input/IP_2040_14_PIC_trial.csv", index_col=0)
# %% [markdown]
...
# "set_yearsSel"
m.set.add(["2020", "2030"], "yearssel")  # years to be optimised
# %% [markdown]
...
tech_specss = {
    ...
    "DW_Electric_converter_D": {"lifeTime": 25, "activityUpperLimit": 1, "mipUnits": 0},
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [
            ["BG_N", "PV_N", "WindOnshore_N", "Wave_N","WindOffshore_N", "Hydro_N", "DW_Electric_converter_D", "ST_N", "LDV_BF", "RO", "AEL","Ammonia_synthesis", "DAC", "Methanol_synthesis", "HP", "FTL","AEL_10","AEL_100"],
            ['2030'],
            ["Powergen"],
            ["Biomass", "Elec", "CO2", "DHW_Elecc", "T_LDV_BF","Pure_water", "Hydrogen", "Heat", "Ammonia", "co", "Methanol", "eKerosene"],
        ]
    )
)
...
converter_coefficient.loc[idx["DW_Electric_converter_D",:,:,"DHW_Elecc"], "coefficient"] = 1  # GWh_el # GWh_ch
converter_coefficient.loc[idx["DW_Electric_converter_D",:, :, "Elec"], "coefficient"] = -1.05
converter_coefficient.loc[idx["DW_Electric_converter_D",:, :, "CO2"], "coefficient"] = 0

converter_coefficient.loc[idx["ST_N",:,:,"DHW_Elecc"], "coefficient"] = 1  # GWh_el # GWh_ch
...
converter_coefficient.loc[idx["AEL_100",:,:,"Pure_water"], "coefficient"] = -0.0450  # (1000 * m3) (Based on 15L/KG H2 from IRENA data and 70% eff)
converter_coefficient.loc[idx["AEL_100",:,:,"Elec"], "coefficient"] = -.142 
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [
            ...
            ["global"],
            ["horizon"],
            ["DG", "BG_B", "PV_B", "WindOnshore_B", "Hydro_B", "Geothermal_B", "MDV","HDV", "LDV", "Bus", "Two_wheel", "Aviation", "Marine", "cook", "Industry", "DW_LPG_converter", "DW_Electric_converter", "HFOO", "PV_N", "WindOnshore_N", "Wave_N", "WindOffshore_N", "BG_N"],
            ['2020'],
        ]
    )
).sort_index()
...
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "cook", "2020"], "perUnitBuild"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "cook", "2020"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "cook", "2020"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "cook", "2020"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "cook", "2020"], "perUnitTotal"
] = 0
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [
            ...
            ["global"],
            ["horizon"],
            ["PV_N", "WindOnshore_N", "Wave_N", "WindOffshore_N", "BG_N", "Hydro_N", "DW_Electric_converter_D", "ST_N", "LDV_BF", "RO", "AEL","AEL_10","AEL_100","Ammonia_synthesis", "DAC", "Methanol_synthesis", "HP", "FTL"],
            ['2030'],
        ]
    )
).sort_index()
...
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DW_Electric_converter_D", "2030"], "perUnitBuild"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DW_Electric_converter_D", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DW_Electric_converter_D", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DW_Electric_converter_D", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "DW_Electric_converter_D", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "ST_N", "2030"], "perUnitBuild"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "ST_N", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "ST_N", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "ST_N", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "ST_N", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "LDV_BF", "2030"], "perUnitBuild"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "LDV_BF", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "LDV_BF", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "LDV_BF", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "LDV_BF", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "RO", "2030"], "perUnitBuild"
] = 400
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "RO", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "RO", "2030"], "amorTime"
] = 25
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "RO", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "RO", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL", "2030"], "perUnitBuild"
] = 400
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL", "2030"], "useAnnuity"
] = 1
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL", "2030"], "amorTime"
] = 25
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL", "2030"], "interest"
] = 0.06
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "AEL", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_10", "2030"], "perUnitBuild"
] = 200
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_10", "2030"], "useAnnuity"
] = 1
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_10", "2030"], "amorTime"
] = 25
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_10", "2030"], "interest"
] = 0.06
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "AEL_10", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_100", "2030"], "perUnitBuild"
] = 500
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_100", "2030"], "useAnnuity"
] = 1
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_100", "2030"], "amorTime"
] = 25
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "AEL_100", "2030"], "interest"
] = 0.06
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "AEL_100", "2030"], "perUnitTotal"
] = 0


accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Ammonia_synthesis", "2030"], "perUnitBuild"
] = 500
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Ammonia_synthesis", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Ammonia_synthesis", "2030"], "amorTime"
] = 25
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Ammonia_synthesis", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "Ammonia_synthesis", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DAC", "2030"], "perUnitBuild"
] = 500
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DAC", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DAC", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "DAC", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "DAC", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Methanol_synthesis", "2030"], "perUnitBuild"
] = 500
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Methanol_synthesis", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Methanol_synthesis", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "Methanol_synthesis", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "Methanol_synthesis", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "HP", "2030"], "perUnitBuild"
] = 500
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "HP", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "HP", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "HP", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "HP", "2030"], "perUnitTotal"
] = 0

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "FTL", "2030"], "perUnitBuild"
] = 500
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "FTL", "2030"], "useAnnuity"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "FTL", "2030"], "amorTime"
] = 0
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "FTL", "2030"], "interest"
] = 0
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "FTL", "2030"], "perUnitTotal"
] = 0
accounting_converterUnits = accounting_converterUnits.fillna(0)
...
sourcesink_config
############################################################
demand_R4_R5_CH = profiles[["LDV_BF_CI_2030", "LDV_BF_FJ_2030","LDV_BF_FSM_2030", "LDV_BF_KB_2030", "LDV_BF_MI_2030","LDV_BF_NU_2030","LDV_BF_NE_2030","LDV_BF_PU_2030","LDV_BF_PNG_2030","LDV_BF_SA_2030","LDV_BF_SI_2030","LDV_BF_TA_2030","LDV_BF_TU_2030","LDV_BF_VU_2030"]]
...
demand_R4_R5_CH = demand_R4_R5_CH.rename(
    index={"LDV_BF_CI_2030": "CI_data", "LDV_BF_FJ_2030": "FJ_data", "LDV_BF_FSM_2030": "FSM_data", "LDV_BF_KB_2030": "KB_data", "LDV_BF_MI_2030": "MI_data","LDV_BF_NU_2030": "NU_data","LDV_BF_NE_2030": "NE_data","LDV_BF_PU_2030": "PU_data","LDV_BF_PNG_2030": "PNG_data","LDV_BF_SA_2030": "SA_data","LDV_BF_SI_2030": "SI_data","LDV_BF_TA_2030": "TA_data","LDV_BF_TU_2030": "TU_data","LDV_BF_VU_2030": "VU_data"}
)

# add columns and set them as index
demand_R4_R5_CH["years"] = "2030"
demand_R4_R5_CH["techs"] = "Demand"
demand_R4_R5_CH["commodity"] = "T_LDV_BF"
demand_R4_R5_CH["type"] = "fixed"
demand_R4_R5_CH = demand_R4_R5_CH.set_index(
    ["years", "techs", "commodity", "type"], append=True
)
...
sourcesink_config
#############################################################
demand_R4_R10_CH = profiles[["DHWP_CI_2030", "DHWP_FJ_2030","DHWP_FSM_2030", "DHWP_KB_2030", "DHWP_MI_2030","DHWP_NU_2030","DHWP_NE_2030","DHWP_PU_2030","DHWP_PNG_2030","DHWP_SA_2030","DHWP_SI_2030","DHWP_TA_2030","DHWP_TU_2030","DHWP_VU_2030"]]
...
demand_R4_R10_CH = demand_R4_R10_CH.rename(
    index={"DHWP_CI_2030": "CI_data", "DHWP_FJ_2030": "FJ_data", "DHWP_FSM_2030": "FSM_data", "DHWP_KB_2030": "KB_data", "DHWP_MI_2030": "MI_data","DHWP_NU_2030": "NU_data","DHWP_NE_2030": "NE_data","DHWP_PU_2030": "PU_data","DHWP_PNG_2030": "PNG_data","DHWP_SA_2030": "SA_data","DHWP_SI_2030": "SI_data","DHWP_TA_2030": "TA_data","DHWP_TU_2030": "TU_data","DHWP_VU_2030": "VU_data"}
)

# add columns and set them as index
demand_R4_R10_CH["years"] = "2030"
demand_R4_R10_CH["techs"] = "Demand"
demand_R4_R10_CH["commodity"] = "DHW_Elecc"
demand_R4_R10_CH["type"] = "fixed"
demand_R4_R10_CH = demand_R4_R10_CH.set_index(
    ["years", "techs", "commodity", "type"], append=True
)
...
sourcesink_config = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [m.set.nodesdata, m.set.yearssel, ["Demand"], ["DHW_Elecc"]]
    )
)
sourcesink_config.loc[idx[["CI_data","FJ_data","FSM_data","KB_data","MI_data","NU_data","NE_data","PU_data","PNG_data","SA_data","SI_data","TA_data","TU_data","VU_data"], :, :, :], "usesFixedProfile"] = 1
sourcesink_config = sourcesink_config.dropna()
...
sourcesink_config
##################################################################################
demand_R4_R10_CH = profiles[["ME_CI_2030", "ME_FJ_2030","ME_FSM_2030", "ME_KB_2030", "ME_MI_2030","ME_NU_2030","ME_NE_2030","ME_PU_2030","ME_PNG_2030","ME_SA_2030","ME_SI_2030","ME_TA_2030","ME_TU_2030","ME_VU_2030"]]
...
demand_R4_R10_CH = demand_R4_R10_CH.rename(
    index={"ME_CI_2030": "CI_data", "ME_FJ_2030": "FJ_data", "ME_FSM_2030": "FSM_data", "ME_KB_2030": "KB_data", "ME_MI_2030": "MI_data","ME_NU_2030": "NU_data","ME_NE_2030": "NE_data","ME_PU_2030": "PU_data","ME_PNG_2030": "PNG_data","ME_SA_2030": "SA_data","ME_SI_2030": "SI_data","ME_TA_2030": "TA_data","ME_TU_2030": "TU_data","ME_VU_2030": "VU_data"}
)

# add columns and set them as index
demand_R4_R10_CH["years"] = "2030"
demand_R4_R10_CH["techs"] = "Demand"
demand_R4_R10_CH["commodity"] = "Ammonia"
demand_R4_R10_CH["type"] = "fixed"
demand_R4_R10_CH = demand_R4_R10_CH.set_index(
    ["years", "techs", "commodity", "type"], append=True
)
...
sourcesink_config = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [m.set.nodesdata, m.set.yearssel, ["Demand"], ["Ammonia"]]
    )
)
sourcesink_config.loc[idx[["CI_data","FJ_data","FSM_data","KB_data","MI_data","NU_data","NE_data","PU_data","PNG_data","SA_data","SI_data","TA_data","TU_data","VU_data"], :, :, :], "usesFixedProfile"] = 1
sourcesink_config = sourcesink_config.dropna()
...
sourcesink_config
###################################################################################
demand_R4_R10_CH = profiles[["AM_CI_2030", "AM_FJ_2030","AM_FSM_2030", "AM_KB_2030", "AM_MI_2030","AM_NU_2030","AM_NE_2030","AM_PU_2030","AM_PNG_2030","AM_SA_2030","AM_SI_2030","AM_TA_2030","AM_TU_2030","AM_VU_2030"]]
...
demand_R4_R10_CH = demand_R4_R10_CH.rename(
    index={"AM_CI_2030": "CI_data", "AM_FJ_2030": "FJ_data", "AM_FSM_2030": "FSM_data", "AM_KB_2030": "KB_data", "AM_MI_2030": "MI_data","AM_NU_2030": "NU_data","AM_NE_2030": "NE_data","AM_PU_2030": "PU_data","AM_PNG_2030": "PNG_data","AM_SA_2030": "SA_data","AM_SI_2030": "SI_data","AM_TA_2030": "TA_data","AM_TU_2030": "TU_data","AM_VU_2030": "VU_data"}
)

# add columns and set them as index
demand_R4_R10_CH["years"] = "2030"
demand_R4_R10_CH["techs"] = "Demand"
demand_R4_R10_CH["commodity"] = "eKerosene"
demand_R4_R10_CH["type"] = "fixed"
demand_R4_R10_CH = demand_R4_R10_CH.set_index(
    ["years", "techs", "commodity", "type"], append=True
)
...
sourcesink_config
####################################################################################
demand_R4_R10_CH = profiles[["FTL_CI_2030", "FTL_FJ_2030","FTL_FSM_2030", "FTL_KB_2030", "FTL_MI_2030","AM_NU_2030","FTL_NE_2030","FTL_PU_2030","FTL_PNG_2030","FTL_SA_2030","FTL_SI_2030","FTL_TA_2030","FTL_TU_2030","FTL_VU_2030"]]
...
demand_R4_R10_CH = demand_R4_R10_CH.rename(
    index={"FTL_CI_2030": "CI_data", "FTL_FJ_2030": "FJ_data", "FTL_FSM_2030": "FSM_data", "FTL_KB_2030": "KB_data", "FTL_MI_2030": "MI_data","FTL_NU_2030": "NU_data","FTL_NE_2030": "NE_data","FTL_PU_2030": "PU_data","FTL_PNG_2030": "PNG_data","FTL_SA_2030": "SA_data","FTL_SI_2030": "SI_data","FTL_TA_2030": "TA_data","FTL_TU_2030": "TU_data","FTL_VU_2030": "VU_data"}
)

# add columns and set them as index
demand_R4_R10_CH["years"] = "2030"
demand_R4_R10_CH["techs"] = "Demand"
demand_R4_R10_CH["commodity"] = "Methanol"
demand_R4_R10_CH["type"] = "fixed"
demand_R4_R10_CH = demand_R4_R10_CH.set_index(
    ["years", "techs", "commodity", "type"], append=True
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata, ["2030"], ["FuelImport"], ["Biomass"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata, ["2030"], ["FuelImport"], ["NG"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata, ["2030"], ["FuelImport"], ["HFOO"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata,["2030"], ["FuelImport"], ["Diesel"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata, ["2030"], ["FuelImport"], ["LPG"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata, ["2030"], ["FuelImport"], ["Gasoline"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata,  ["2030"], ["FuelImport"], ["JetA1"]]
    )
)
...
accounting_sourcesinkFlow = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["FuelCost"], m.set.nodesdata,  ["2030"], ["FuelImport"], ["MDO"]]
    )
)
...
# "converter_techParam"
converter_techParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["Battery"], ['2030']])
)
...
# "converter_capacityParam"
converter_capacityParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([m.set.nodesdata, ['2030'], ["Battery"]])
)
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Battery"], ['2030'], ["Charge", "Discharge"], ["Elec", "Elec_LiIon"]]
    )
)
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Invest", "OMFix"], ["global"], ["horizon"], ["Battery"], ['2030']]
    )
)
...
storage_sizeParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["Battery"], ['2030'], ["Elec_LiIon"]])
)
...
##########################################thermal storage_2####################
converter_techParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["THSS"], ['2030']])
)
...
# "converter_capacityParam"
converter_capacityParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([m.set.nodesdata, ['2030'], ["THSS"]])
)
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["THSS"], ['2030'], ["Charge", "Discharge"], ["Heat", "Heat_T"]]
    )
)
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Invest", "OMFix"], ["global"], ["horizon"], ["THSS"], ['2030']]
    )
)
...
# size of each storage unit
storage_sizeParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["THSS"], ['2030'], ["Heat_T"]])
)
...
converter_techParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["THS"], ['2030']])
)
converter_techParam.loc[idx["THS", :], "lifeTime"] = 30
converter_techParam.loc[idx["THS", :], "activityUpperLimit"] = 1
...
# "converter_capacityParam"
converter_capacityParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([m.set.nodesdata, ['2030'], ["THS"]])
)
converter_capacityParam.loc[idx[["CI_data","FJ_data","FSM_data","KB_data","MI_data","NU_data","NE_data","PU_data","PNG_data","SA_data","SI_data","TA_data","TU_data","VU_data"], :, "THS"], "unitsUpperLimit"] = (
  300  # GW_el Converter upper limit
)
  # GW_el Converter upper limit
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["THS"], ['2030'], ["Charge", "Discharge"], ["DHW_Elecc", "DHW_Elecc_T"]]
    )
)

converter_coefficient.loc[
    idx["THS", :, "Charge", "DHW_Elecc"], "coefficient"
] = -1  # GW_el
converter_coefficient.loc[idx["THS", :, "Charge", "DHW_Elecc_T"], "coefficient"] = (
    0.99  # GW_el in LiIon
)
converter_coefficient.loc[idx["THS", :, "Discharge", "DHW_Elecc"], "coefficient"] = (
    1  # GW_el
)
converter_coefficient.loc[
    idx["THS", :, "Discharge", "DHW_Elecc_T"], "coefficient"
] = -1.01  # GW_el in LiIon
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Invest", "OMFix"], ["global"], ["horizon"], ["THS"], ['2030']]
    )
)

accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "THS", "2030"], "perUnitBuild"
] = 0  # million EUR / unit
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "THS", "2030"], "useAnnuity"
] = 1  # binary yes/no
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "THS", "2030"], "amorTime"
] = 25  # years
accounting_converterUnits.loc[
    idx["Invest", "global", "horizon", "THS", "2030"], "interest"
] = 0.06  # percent/100
accounting_converterUnits.loc[
    idx["OMFix", "global", "horizon", "THS", "2030"], "perUnitTotal"
] = 1
...
storage_techParam.loc[idx["THS", :], "lifeTime"] = 30
storage_techParam.loc[idx["THS", :], "levelUpperLimit"] = 1
...
# size of each storage unit
storage_sizeParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["THS"], ['2030'], ["DHW_Elecc_T"]])
)
storage_sizeParam.loc[idx["THS", :, "DHW_Elecc_T"], "size"] = 1 # GWh_ch/unit
storage_sizeParam = storage_sizeParam.dropna()
...
storage_reservoirParam.loc[idx[["CI_data","FJ_data","FSM_data","KB_data","MI_data","NU_data","NE_data","PU_data","PNG_data","SA_data","SI_data","TA_data","TU_data","VU_data"], :, "THS"], "unitsUpperLimit"] = (
    1000 
)# units
...
converter_techParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["H2_storage"], ['2030']])
)
...
# "converter_capacityParam"
converter_capacityParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([m.set.nodesdata, ['2030'], ["H2_storage"]])
)
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["H2_storage"], ['2030'], ["Charge", "Discharge"], ["Hydrogen", "Hydrogen_T"]]
    )
)
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Invest", "OMFix"], ["global"], ["horizon"], ["H2_storage"], ['2030']]
    )
)
...
# size of each storage unit
storage_sizeParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["H2_storage"], ['2030'], ["Hydrogen_T"]])
)
...
converter_techParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["Ammonia_storage"], ['2030']])
)
...
# "converter_capacityParam"
converter_capacityParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([m.set.nodesdata, ['2030'], ["Ammonia_storage"]])
)
...
converter_coefficient = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Ammonia_storage"], ['2030'], ["Charge", "Discharge"], ["Ammonia", "Ammonia_T"]]
    )
)
...
accounting_converterUnits = pd.DataFrame(
    index=pd.MultiIndex.from_product(
        [["Invest", "OMFix"], ["global"], ["horizon"], ["Ammonia_storage"], ['2030']]
    )
)
...
# size of each storage unit
storage_sizeParam = pd.DataFrame(
    index=pd.MultiIndex.from_product([["Ammonia_storage"], ['2030'], ["Ammonia_T"]])
)
