...
# ============================================================================
# Inter-island transfer links (ammonia / methanol / e-kerosene shipping)
# ============================================================================
link_names = [
    "Ship__Z_1", "Ship__Z_2", "Ship__Z_3", "Ship__Z_4", "Ship__Z_5",
    "Ship__Z_6", "Ship__Z_7", "Ship__Z_8", "Ship__Z_9", "Ship__Z_10",
    "Ship__Z_11", "Ship__Z_12", "Ship__Z_13", "Ship__Z_14", "Ship__Z_15",
    "Ship__Z_16", "Ship__Z_17", "Ship__Z_18", "Ship__Z_19", "Ship__Z_20",
    "Ship__Z_21", "Ship__Z_22",
]
...
_SECTORS_PTX = {
    ...
    "Bus_el": (0, 1000), "Aviation_el": (0, 1000),
    "cook_el": (0, 1000), "cook_LPG": (0, 1000),
    "Industry_EH": (0, 1000),
    ...
    index=pd.MultiIndex.from_product(
        [
            ["BG_N", "PV_N", "WindOnshore_N", "Wave_N", "WindOffshore_N", "ST_N",
             ...
             "MDV_el", "MDV_BF", "Two_wheel_el", "Bus_el", "Aviation_el",
             "cook_el", "cook_LPG", "Industry_EH",
             "Dummy_Ammonia", "Dummy_Methanol", "Ship_BEV"],
            ["2040", "2050"],
            ["Powergen"],
...
AEL_BUILD_2040 = {
    "CI_data": 1086, "FJ_data": 709, "FSM_data": 752, "KB_data": 834,
    "MI_data": 1250, "NU_data": 1021, "NE_data": 2100, "PU_data": 701,
    "PNG_data": 478, "SA_data": 805, "SI_data": 689, "TA_data": 755,
    "TU_data": 2100, "VU_data": 660,
}
AEL_BUILD_2050 = {
    "CI_data": 647, "FJ_data": 467, "FSM_data": 483, "KB_data": 505,
    "MI_data": 623, "NU_data": 766, "NE_data": 1591, "PU_data": 541,
    "PNG_data": 364, "SA_data": 517, "SI_data": 469, "TA_data": 474,
    "TU_data": 1319, "VU_data": 505,
}
...
COSTS_2040 = {
    ...
    "Two_wheel_el": _zero_cost(), "Bus_el": _zero_cost(),
    "Aviation_el": _zero_cost(),
    "cook_el": _zero_cost(), "cook_LPG": _zero_cost(),
    "Industry_EH": _zero_cost(),
}
...
add_transfer_link_costs(m, transfer_techs, 0.0000001, 0.0021)    # port_A (Ammonia)
add_transfer_link_costs(m, transfer_techs_M, 0.000001, 0.0014)   # port_M (Methanol)
add_transfer_link_costs(m, transfer_techs_F, 0.000001, 0.0008)   # port_F (eKerosene)
...
add_transfer_link_costs(m, transfer_techs, 0.000001, 0.0021)     # port_A (Ammonia)
add_transfer_link_costs(m, transfer_techs_M, 0.000001, 0.0014)   # port_M (Methanol)
add_transfer_link_costs(m, transfer_techs_F, 0.000001, 0.0008)   # port_F (eKerosene)
...
EFUEL_LIMIT = [1000000] * len(EFUEL_NODES)
add_fuel_import_limits(m, EFUEL_NODES, "Methanol", EFUEL_LIMIT)
add_fuel_import_limits(m, EFUEL_NODES, "eKerosene", EFUEL_LIMIT)
add_fuel_import_limits(m, EFUEL_NODES, "Ammonia", EFUEL_LIMIT)
...
for commodity in ["Ammonia", "Methanol", "eKerosene"]:
    add_fuel_import_config(m, EFUEL_NODES, commodity)
for commodity in ["NG", "HFOO", "Diesel", "LPG", "Gasoline", "JetA1", "MDO"]:
...
EFUEL_PRICES = {
    "Ammonia": {"2040": 0.080, "2050": 0.066},
    "Methanol": {"2040": 0.0884, "2050": 0.0735},
    "eKerosene": {"2040": 0.114, "2050": 0.0971},
}
for commodity, by_year in EFUEL_PRICES.items():
    for year, price in by_year.items():
        add_fuel_prices(m, EFUEL_NODES, [year], commodity, _flat(price, EFUEL_NODES))
